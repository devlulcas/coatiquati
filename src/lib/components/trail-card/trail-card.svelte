...
<a href={trail.slug} class="relative flex flex-col w-full bg-white rounded-md overflow-clip border border-white/25">
	...
	<img class="object-cover w-full h-96 lg:h-80" src={trail.thumbnail} alt={trail.title} />
	...
	<div class="p-4 h-full flex flex-col justify-between">
		<div>
			...
			<time class="block mt-2 text-sm text-gray-500" datetime={trail.updatedAt.toISOString()}>
