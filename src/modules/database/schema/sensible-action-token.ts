...
export type SensibleOperationTokenTable = InferSelectModel<typeof sensibleOperationTokenTable>;

export type NewSensibleOperationTokenTable = InferInsertModel<typeof sensibleOperationTokenTable>;

export const sensibleOperationTokenTable = sqliteTable('user_sensible_operation_token', {
